...
# compare models
#anova(model_1, model_2) - compare House vs Price every 20 years
...
priceByDecade <- data.frame(Price = kc_cleanData_df$price, Decade = kc_cleanData_df$yr_built)

for (i in 1:9000){
  if (priceByDecade$Decade[i]<1925){
    priceByDecade$Decade[i] <- '1900-1920'
  }
   else if (priceByDecade$Decade[i]>1920 && priceByDecade$Decade[i]<1940){
    priceByDecade$Decade[i] <- '1920-1940'
   }
   else if (priceByDecade$Decade[i]>1940 && priceByDecade$Decade[i]<1960){
    priceByDecade$Decade[i] <- '1940-1960'
  }
  else if (priceByDecade$Decade[i]>1960 && priceByDecade$Decade[i]<1980){
    priceByDecade$Decade[i] <- '1960-1980'
  }
   else if (priceByDecade$Decade[i]>1980 && priceByDecade$Decade[i]<2000){
    priceByDecade$Decade[i] <- '1980-2000'
  }
    else {
...
# run Anova
anova <- aov(priceByDecade$Price ~priceByDecade$Decade, data=priceByDecade)
...
plot(pricesIn100k ~ priceByDecade$Decade,
     data=priceByDecade,
     main = 'Anova Price ~ Every 20 year',
     xlab = 'every 20 years',
